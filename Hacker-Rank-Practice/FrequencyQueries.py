...
# SOLUTION:
    ...
    # Step 5: Check if the x axis element in the query is set to 1, if it is, increment the value if it exists in the 1st dictionary (frequency), and increment the value for the given key in the 2nd dictionary (frequencyValues)
